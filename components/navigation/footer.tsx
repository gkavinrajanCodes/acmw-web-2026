        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-4 mb-5">
              <div className="bg-white/90 px-3 py-1.5 rounded-xl shadow-[0_2px_15px_rgba(255,255,255,0.08)] flex items-center justify-center border border-white/20">
                <Image 
                  src="/acm-w logo.png" 
                  alt="ACM-W Logo" 
                  width={140} 
                  height={70} 
                  className="h-8 w-auto object-contain drop-shadow-sm scale-125" 
                />
              </div>
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-md mb-6">
              Empowering women in computing at SSN College of Engineering.
              Building a community of innovators, creators, and leaders in
              technology.
            </p>
